...
//       const { formCode, poNo, item_id, docNo, docNoYearly, docDate, qty } =
//         entry;
//       const stock_id =
//         Date.now() +
//         Math.floor(Math.random() * 1000) +
//         newSummaryEntries.length;
...
//         } else {
//           console.error(
//             `No matching stock found for update: PO=${poNo}, Item=${item_id}`
//           );
//           return;
//         }
//       }
...
//       if (
//         stockDetail
//           .filter((it) => it.stock_id === stockNo)
//           .find((ele) => ele.formCode === "IMI")
//       ) {
...
//         setStockDetail((prev) =>
//           prev.filter(
//             (item) => !(item.stock_id === stockNo && item.item_id === item_id)
//           )
//         );
//       } else {
//         setStockDetail((prev) =>
//           prev.filter(
//             (item) => !(item.stock_id === stockNo && item.formCode === "IGRN")
//           )
//         );
//       }
//     }
...
//   return [error, setInsert, setUpdate, setDelete];
// }
